...
* The procedure uses DBI to modify the database (queries do not appear to be
affected by this bug, but your mileage may vary).
...
around it for now.  If this really bothers you, store your DML code in the
